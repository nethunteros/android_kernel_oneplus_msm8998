...
#
# *******************************
# Oneplus 5 LineageOS 14.1 version
#
# V0.1
# *******************************
...
KERNEL_SPECS="oneplus5;cm;cm14.0;http://kernel.boeffla.de/oneplus5/boeffla-kernel-cm/;boeffla-kernel-#VERSION#-Lineage14.1-OnePlus5-anykernel.recovery.zip"
